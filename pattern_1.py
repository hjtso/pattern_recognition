...
def needRotation():
    ...
    cv2.imwrite('/Users/huangjintao/Desktop/pattern/rotation.png', imgRotation)
...
cv2.imwrite('/Users/huangjintao/Desktop/pattern/analytics.png', img3)
